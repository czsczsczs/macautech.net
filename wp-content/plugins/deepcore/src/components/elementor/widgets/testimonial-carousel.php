...
class Webnus_Element_Widgets_Testimonial_Carousel extends \Elementor\Widget_Base {
	...
	public function get_title() {
		...
		return esc_html__( 'Testimonial Carousel', 'deep' );
	...
	public function get_icon() {
		...
		return 'deep-widget deep-eicon-testimonial-carousel';
		...
		$this->add_control(
			...
			[
				...
				'fields' 		=> [
					...
					[
                        'name' 			=> 'link',
                        'label' 		=> esc_html__( 'Testimonial Link', 'deep' ),
                        'type' 			=> Controls_Manager::TEXT,
                        'label_block' 	=> true,
                    ],   
                ],
            ...
            $out = '<div class="testimonial-carousel testi-carou-' . $type . ' ' . $shortcodeclass . '"  ' . $shortcodeid . '>';
                $out .= '<div class="testimonial-owl-carousel owl-carousel owl-theme" data-count="' . $items . '">';
                        foreach ( $testimonial_item as $line ) :
                            ...
                            $out .= '<div class="tc-item">' . $img . $tc_content . $name . $job . $link .'</div>';
                        endforeach;
                $out .= '</div>';
            $out .= '</div>';
            echo $out;
            ...
            $out = '<div class="testimonial-carousel testi-carou-' . $type . ' ' . $shortcodeclass . '"  ' . $shortcodeid . '>';
                $out .= '<div class="testimonial-owl-carousel owl-carousel owl-theme" data-count="' . $items . '">';
                    foreach ( $testimonial_item as $line ) :
                            ...
                            // $link           =  !empty( $line['link'] ) ? '<p class="tc-link">'. esc_attr( $this->get_field_id('link') ) .esc_html_e('Ad link URL:','deep') .'<input type="text" class="widefat" id="'. esc_attr( $this->get_field_id('link') ) ." name=". esc_attr( $this->get_field_name('link') ) ." value=" .esc_attr($link)  ." />".'</p>': '';
