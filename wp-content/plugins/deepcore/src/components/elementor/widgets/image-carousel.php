...
class Webnus_Element_Widgets_Image_Carousel extends \Elementor\Widget_Base {
	...
	public function get_title() {
		...
		return esc_html__( 'Image Carousel', 'deep' );
	...
	public function get_icon() {
		...
		return 'deep-widget deep-eicon-image-carousel';
	...
	protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'max'           => 24,
                'step'          => 1,
                'description'   => esc_html__( 'Type nothing to default (6).', 'deep'),
				'condition'     => [
					'type'      	=> [
						'type1',
					],
		...
		$this->add_control(
			'item_carousle1',
            [
                'label'         => esc_html__( 'Carousle Items1', 'deep' ),
                'type'          => Controls_Manager::NUMBER,
                'default'       => 1,
                'min'           => 1,
                'max'           => 24,
                'step'          => 1,
                'description'   => esc_html__( 'Type nothing to default (1).', 'deep'),
				'condition'     => [
					'type'      	=> [
						'type2',
					],
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => __( 'Background', 'deep' ),
				'types'    => [ 'classic' , 'gradient' ],
				'selector' => '#wrap {{WRAPPER}} .services-carousel',
			]
		);
		$this->add_control(
			'box_display',
			[
				...
				'selectors' => [
					'#wrap {{WRAPPER}} .services-carousel' => 'display: {{VALUE}};',
				],
			]
		);
		$this->add_group_control(
		...
		$this->add_control(
			...
			[
				...
				'size_units'    => [ 'px', 'em', '%' ],
				'selectors'     => [
					'#wrap {{WRAPPER}} .services-carousel' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_group_control(
		...
		$this->add_control(
			...
			[
				...
				'size_units'    => [ 'px', 'em', '%' ],
				'selectors'     => [
					'#wrap {{WRAPPER}} .services-carousel' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'size_units'    => [ 'px', 'em', '%' ],
				'selectors'     => [
					'#wrap {{WRAPPER}} .services-carousel' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'#wrap {{WRAPPER}} .services-carousel' => 'opacity: {{SIZE}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'#wrap {{WRAPPER}} .services-carousel' => 'overflow: {{VALUE}};',
				],
			]
		);
		$this->add_control(
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => __( 'Background', 'deep' ),
				'types'    => [ 'classic' , 'gradient' ],
				'selector' => '#wrap {{WRAPPER}} .services-carousel:hover',
			]
		);
		$this->add_control(
			'box_display_hover',
			[
				...
				'selectors' => [
					'#wrap {{WRAPPER}} .services-carousel:hover' => 'display: {{VALUE}};',
				],
			]
		);
		$this->add_group_control(
		...
		$this->add_control(
			...
			[
				...
				'size_units'    => [ 'px', 'em', '%' ],
				'selectors'     => [
					'#wrap {{WRAPPER}} .services-carousel:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_group_control(
		...
		$this->add_control(
			...
			[
				...
				'size_units'    => [ 'px', 'em', '%' ],
				'selectors'     => [
					'#wrap {{WRAPPER}} .services-carousel:hover' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'size_units'  => [ 'px', 'em', '%' ],
				'selectors'   => [
					'#wrap {{WRAPPER}} .services-carousel:hover' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'#wrap {{WRAPPER}} .services-carousel:hover' => 'opacity: {{SIZE}};',
				],
			]
		);
		$this->end_controls_section();
	...
	protected function render() {
		...
		$item_carousle  		= $settings['item_carousle'] ? $settings['item_carousle'] : '6';
		$item_carousle1  		= $settings['item_carousle1'] ? $settings['item_carousle1'] : '1';  
		...
		if ( $type == 'type1') {
			...
			<div class="clearfix ">
					<div class="w-image-carousel owl-carousel owl-theme ' . $shortcodeclass . '"  ' . $shortcodeid . ' data-items="' . $item_carousle . '" >';
						foreach ( $image_item as $line ) :
							...
							$out .='<div class="services-carousel">' . '<a target="_blank" href="' . $link_url . '"' .' ' . $link_target . ' ' . $nofollow . '>'.$img. '</a>' . ' </div>';
			...
			$out = '
			<div class="clearfix">
					<div class="wn-vertical-carousel w-image-carousel-type2 owl-carousel owl-theme ' . $shortcodeclass . '"  ' . $shortcodeid . ' data-items="' . $item_carousle1 . '" >';
