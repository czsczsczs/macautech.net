...
class Deep_Theme {
    ...
    private function hooks() {
        ...
        add_action( 'llms_single', [$this, 'llms_single'] );
	}
                        ...
                        <div class="header-right-col">
                            <nav id="site-navigation" class="main-navigation">
                                ...
                                <!-- <ul id="primary-menu">
                                    ...
                                    <li><a href="./?page_id=8">首頁</a><span class="n">首頁</span></li>
                                    <li><a href="./?page_id=7020">服務</a><span class="n">服務</span></li>
                                    <li><a href="./?page_id=6281">聯系我們</a><span class="n">聯系我們</span></li>
                                    <li><a href="./?page_id=6228">關於我們</a><span class="n">關於我們</span></li>
                                </ul> -->
                            </nav><!-- #site-navigation -->
                        </div>
                    </div>
	...
	public function deep_theme_setup() {
        ...
        // Add theme support for LifterLMS sidebars.
